...
#define MY_SOURCE_NAME "/Users/ac/Documents/study_files/coding/complier_anchor/test_ir_correct.anchor"
...
int main(int argc, char* argv[]) {
    ...
    // --- 1. 获取源文件 (逻辑保持不变) ---
    std::string sourceFilename = MY_SOURCE_NAME; // 默认文件
    // ... (您可以保留或移除文件选择对话框的逻辑) ...
    std::cout << "使用测试文件: " << sourceFilename << std::endl;
    std::cout << "--------------------------------------" << std::endl;
